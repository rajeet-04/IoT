...
export default function RegisterPage() {
    return (
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#050505] selection:bg-cyan-500/30">
            ...
            <div className="absolute top-[-10%] right-[-10%] w-96 h-96 bg-cyan-600/20 rounded-full blur-[120px] pointer-events-none" />
            <div className="absolute bottom-[-10%] left-[-10%] w-[30rem] h-[30rem] bg-indigo-600/20 rounded-full blur-[120px] pointer-events-none" />
                ...
                <div className="glass-panel rounded-3xl p-8 sm:p-10 relative overflow-hidden">
                    ...
                    <div className="text-center mb-10 flex flex-col items-center">
                        ...
                        <p className="text-slate-400 mt-3 text-sm font-medium">
                            Start controlling your hardware in seconds
                        </p>
                    </div>
